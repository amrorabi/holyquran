...
jQuery.ajaxSetup({
 	'complete': function() { jQuery('abbr.timeago').timeago(); alert('2');}
});
		...
		function() {
			...
			$.ajax({
				...
				success : function(data, status, jqXHR) {
					...
					alert('1');
					$('#timeline').append("<abbr class=\"timeago\" title=\"2008-07-17T09:24:17Z\">");
//					var dateLabel = "";
...
//									"<abbr class=\"timeago\" title=\"2008-07-17T09:24:17Z\">" +
//										"</span>" +
//									"<h3 class=\"timeline-header no-border\">" +
//										"<a href=\"#\">" + value.from.name + "</a> " + value.message +
//									"</h3>" +
//								"</div></li>");
//					});
